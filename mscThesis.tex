...
%
%-name, date, title
\mscName{R. M. Olsthoorn}%
\mscDate{\today}%
\mscTitle{Segmented active reward \\ learning}%
\mscSubTitle{}%
...
\mscSupervisorOne{dr.ir.~J. Kober~Supervisor}
...
\subfile{reinforcement}
\subfile{rewardlearning}
\subfile{activerl}
\subfile{segmentedarl}
\subfile{experiments}
\subfile{conclusions}
